...
const items = [
  ...
  { Icon: Wine, title: "Espumante & Chopp", text: "Curadoria exclusiva durante todo o evento." },
  { Icon: Car, title: "Test Drive", text: "Frota de carros seletos à disposição." },
  { Icon: Gem, title: "Condições Exclusivas", text: "Oportunidades únicas de aquisição." },
];
